                    ...
                    <td class="p-3 text-center">
                        @php
                            $badgeStyles = match(strtoupper($log->action)) {
                                'PRODUCT REGISTERED', 'STOCK ADDED', 'RECORD ADDED', 'LOGIN SUCCESS' => 'bg-emerald-100 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300',
                                'PRODUCT UPDATED', 'STOCK UPDATED', 'RECORD UPDATED', 'INVENTORY EXPORTED', 'RECORDS EXPORTED' => 'bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300',
                                'PRODUCT ARCHIVED', 'LOGIN FAILED' => 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300',
