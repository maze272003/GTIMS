...
<body class="bg-gray-50 dark:bg-gray-900">
  ...
  <div id="content-wrapper" class="transition-all duration-300 lg:ml-64 md:ml-20">
    ...
    <main id="main-content" class="pt-20 p-4 lg:p-8 min-h-screen">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between">
            ...
            <div class="bg-blue-100 dark:bg-blue-900 p-4 rounded-full">
              <i class="fa-regular fa-boxes-stacked text-2xl text-blue-600 dark:text-blue-400"></i>
            </div>
          </div>
        </div>
        {{-- Low Stock --}}
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <div class="flex items-center justify-between">
            ...
            <div class="bg-green-100 dark:bg-green-900 p-4 rounded-full">
              <i class="fa-regular fa-user-group text-2xl text-green-600 dark:text-green-400"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                <i class="fa-regular fa-chart-line-down text-red-600 dark:text-red-400 mr-2"></i>Stock Depletion Forecast
              </h3>
            ...
            <div class="mt-2 sm:mt-0">
              ...
              <form action="{{ route('admin.dashboard') }}" method="GET" id="forecast-filter-form" class="flex items-center gap-x-2">
                  ...
                  <select name="forecast_days" id="forecast_days_select" class="pl-2 pr-8 py-1 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
          ...
          <div class="overflow-y-auto h-96 relative"> {{-- Added relative for loader --}}
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody id="forecast-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div class="p-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
              <i class="fa-regular fa-triangle-exclamation text-orange-600 dark:text-orange-400 mr-2"></i>Actionable Alerts
            </h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">Items needing immediate attention.</p>
          </div>
          <div class="p-4 overflow-y-auto h-96">
            {{-- Low Stock --}}
            <h4 class="font-semibold text-orange-600 dark:text-orange-400">Critical Low Stock (<= 100)</h4>
            <ul class="divide-y divide-gray-200 dark:divide-gray-700 mt-2">
              @forelse($urgent_low_stock as $item)
                <li class="py-2 flex justify-between items-center">
                  ...
                  <span class="font-bold text-sm text-orange-600 dark:text-orange-400">{{ $item->quantity }} left</span>
                </li>
              @empty
            ...
            {{-- Expiring Soon --}}
            <h4 class="font-semibold text-yellow-600 dark:text-yellow-400 mt-4">Expiring in 30 Days</h4>
            <ul class="divide-y divide-gray-200 dark:divide-gray-700 mt-2">
              @forelse($urgent_expiring_soon as $item)
                <li class="py-2 flex justify-between items-center">
                  ...
                  <span class="font-bold text-sm text-yellow-600 dark:text-yellow-400">
      ...
      <div class="my-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="drilldown-indicator p-4 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-200 dark:border-blue-800 flex items-center justify-between" style="display: {{ $drilldown_product_name ? 'flex' : 'none' }};">
          <div class="flex items-center">
            <i class="fa-regular fa-filter-list text-blue-600 dark:text-blue-400 mr-3"></i>
          ...
          <a href="#" id="clear-drilldown-ajax" class="px-3 py-1 text-xs font-medium text-blue-700 dark:text-blue-300 bg-white dark:bg-gray-700 border border-blue-600 dark:border-blue-400 rounded-full hover:bg-blue-100 dark:hover:bg-blue-800/20">Clear Drill-Down</a>
        </div>
        ...
        <form id="dashboard-filter-form" action="{{ route('admin.dashboard') }}" method="GET">
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4"> {{-- Adjusted to 3 columns --}}
              ...
              <div>
                ...
                <select name="filter_timespan" id="filter_timespan" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              ...
              <div>
                ...
                <select name="filter_barangay" id="filter_barangay" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              ...
              <div>
                ...
                <select name="grouping" id="grouping" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
          ...
          <div id="custom_dates_container" class="p-6 pt-0 {{ ($filterInputs['filter_timespan'] ?? '30d') == 'custom' ? '' : 'hidden' }}">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" name="filter_start" id="filter_start" value="{{ $filterInputs['filter_start'] ?? '' }}" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              </div>
              <div>
                <label for="filter_end" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">End Date</label>
                <input type="date" name="filter_end" id="filter_end" value="{{ $filterInputs['filter_end'] ?? '' }}" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              </div>
            </div>
          </div>
          {{-- Form Actions --}}
          <div class="px-6 pb-4 flex justify-end items-center gap-x-3">
            ...
            <button type="button" onclick="clearAllFilters()" class="px-4 py-2 text-sm text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600">Clear Filters</button>
            <button type="submit" class="px-4 py-2 text-sm text-white bg-blue-600 dark:bg-blue-700 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800">Apply Filters</button>
          </div>
        </form>
      </div>
          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
            ...
            <div id="consumptionChartToggle" class="mt-2 sm:mt-0 flex items-center p-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
              <button data-type="line" class="chart-toggle active-toggle">
                <i class="fa-regular fa-chart-line text-sm text-gray-600 dark:text-gray-400"></i>
              </button>
              <button data-type="bar" class="chart-toggle">
                <i class="fa-regular fa-chart-bar text-sm text-gray-600 dark:text-gray-400"></i>
              </button>
            </div>
          </div>
           ...
           <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
            ...
            <div id="topProductsChartToggle" class="mt-2 sm:mt-0 flex items-center p-1 bg-gray-100 dark:bg-gray-700 rounded-lg">
              ...
              <button data-type="pie" class="chart-toggle">
                <i class="fa-regular fa-chart-pie text-sm text-gray-600 dark:text-gray-400"></i>
              </button>
            </div>
          </div>
           {{-- Subtitle for filters --}}
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          ...
          <form id="seasonal-filter-form">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
              ...
              <button type="submit" class="mt-2 sm:mt-0 px-4 py-2 text-sm text-white bg-blue-600 dark:bg-blue-700 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800">Update Chart</button>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label for="seasonal_product_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Product 1</label>
                <select name="seasonal_product_id" id="seasonal_product_id" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              ...
              <div>
                ...
                <select name="compare_product_id" id="compare_product_id" class="w-full pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
          ...
          <div class="mt-4 text-center">
            <button id="get-ai-analysis" class="inline-flex items-center px-4 py-2 text-sm text-white bg-purple-600 dark:bg-purple-700 rounded-lg hover:bg-purple-700 dark:hover:bg-purple-800 disabled:opacity-50">
          ...
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Dispensation Hotspots</h3>
           ...
           <div class="overflow-y-auto h-96 relative"> {{-- Added relative for loader --}}
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody id="hotspots-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700"> {{-- Add ID for AJAX update --}}
  ...
  {{-- AI Response Modal --}}
  <div id="ai-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/80 hidden">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl">
      <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <button id="close-ai-modal" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400">
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      aiButton.addEventListener('click', async () => {
        ...
        try {
          ...
          aiResponseContent.innerHTML = `<p class="text-red-600 dark:text-red-400 font-semibold">Sorry, the analysis could not be completed.</p><p class="text-sm text-gray-500 dark:text-gray-400 mt-2">${error.message}</p>`;
        } finally {
          aiButton.disabled = false;
          aiButtonText.textContent = 'Get AI Analysis of this Trend';
