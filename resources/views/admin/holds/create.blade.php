        ...
        <main id="main-content" class="pt-20 p-4 lg:p-8 min-h-screen">
            ...
            <div class="mb-6 pt-20 flex justify-between items-center">
                <div class="flex flex-col gap-5">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Home / Holds / <span class="text-red-700 dark:text-red-300 font-medium">Create</span>
                    </p>
            ...
            <form action="{{ route('admin.holds.store') }}" method="POST" id="holdForm">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" required class="w-full border dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-2 focus:ring-2 focus:ring-red-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Reason Code <span class="text-red-500">*</span></label>
                            <input type="text" name="reason_code" value="{{ old('reason_code') }}" required class="w-full border dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-2 focus:ring-2 focus:ring-red-500" placeholder="e.g. QUALITY_CHECK">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="expires_at" value="{{ old('expires_at') }}" class="w-full border dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg p-2 focus:ring-2 focus:ring-red-500">
                ...
                <div class="flex justify-end gap-3 pb-10">
                    <a href="{{ route('admin.holds.index') }}" class="px-6 py-2.5 border border-gray-300 text-gray-700 dark:text-gray-300 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition">Cancel</a>
                    <button type="button" id="submitHoldBtn" class="px-6 py-2.5 bg-red-700 hover:bg-red-800 text-white rounded-lg shadow-md transition">
                        Submit Hold
                    </button>
                </div>
            </form>
    ...
    <div style="display: none;">
        ...
        <select id="masterBatchSelect">
            ...
            @foreach($batches ?? [] as $batch)
                <option value="{{ $batch->id }}" data-product="{{ $batch->product_id }}">{{ $batch->batch_number }} (Qty: {{ $batch->quantity }})</option>
            @endforeach
        </select>
    </div>
