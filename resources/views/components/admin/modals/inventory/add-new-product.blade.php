<div class="fixed w-full h-screen top-0 left-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 hidden" id="addnewproductmodal">
    <div class="modal bg-white dark:bg-gray-800 rounded-lg w-full max-w-lg p-5">
      <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mb-4">
        <p class="text-xl font-medium text-gray-600 dark:text-gray-300">Add New Product</p>
        <button id="closeaddnewproductmodal" class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <form action="{{ route('admin.inventory.addproduct') }}" class="mt-5" method="POST" id="add-product-form">
        ...
        <button id="add-product-btn" type="button" class="bg-blue-500 dark:bg-blue-600 text-white p-2 rounded-lg mt-5 hover:-translate-y-1 hover:shadow-md transition-all duration-200 w-fit">
