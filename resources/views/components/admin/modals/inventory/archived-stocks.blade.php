...
<div class="fixed w-full h-screen top-0 left-0 bg-white/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 hidden" id="viewarchivedstocksmodal">
    <div class="modal bg-white dark:bg-white-800 rounded-lg w-full max-w-4xl max-h-screen overflow-y-auto p-6">
        <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mb-4 sticky top-0 bg-white dark:bg-gray-800 z-10">
            <p class="text-xl font-medium text-gray-700 dark:text-gray-200">Archived Stocks in <span id="archived-product-name" class="font-semibold text-red-500"></span></p>
            <button id="closeviewarchivedstocksmodal" class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
                <i class="fa-regular fa-xmark text-xl dark:text-gray-300"></i>
            </button>
        </div>
        
        <div class="overflow-x-auto overflow-y-auto h-fit max-h-[70vh]" id="archived-stock-list"> 
            <table class="w-full text-sm">
                <thead class="bg-gray-200 text-gray-700 dark:text-gray-300 uppercase text-xs sticky top-0">
                    <tr>
