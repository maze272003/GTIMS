        ...
        <form action="{{ route('admin.inventory.editstock') }}" method="POST" id="editstockform">
            ...
            <div class="flex gap-2 mt-2">
                <div class="w-1/2">
                    ...
                    <input type="text" name="batchnumber" id="edit-batchnumber" required class="mt-1 p-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" value="{{ old('batchnumber') }}" placeholder="Enter Batch Number">
                ...
                <div class="w-1/2">
                    ...
                    <input type="number" name="quantity" id="edit-quantity" required class="mt-1 p-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" value="{{ old('quantity') }}" placeholder="Enter Quantity">
            ...
            <div class="w-full mt-2">
                ...
                <input type="date" name="expiry" id="edit-expiry" required class="mt-1 p-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" value="{{ old('expiry') }}">
