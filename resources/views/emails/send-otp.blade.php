                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #e2e8f0; background-color: #ffffff; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 25px 20px; background-color: #eb0000; color: #ffffff;">
                            ...
                            <img src="{{ url('images/gtlogo.png') }}" alt="Municipality of General Tinio Logo" width="90" style="display: block; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px 40px 30px; color: #333333;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 25px;">
                                <tr>
                                    <td align="center">
                                        <div style="background-color: #f3f4f6; border-radius: 8px; padding: 25px 30px; display: block; border: 1px solid #e5e7eb; text-align: center;">
                            ...
                            <p style="margin-top: 25px; font-size: 14px; color: #dc2626;">
                                <strong>Important:</strong> Do not share this code with anyone. If you did not request this OTP, please ignore this email.
                            </p>
                        </td>
                    </tr>
